...
const loadProfile = async () => {
  const response = await axios.get(process.env.REACT_APP_BEEP_API + '/api/user/my/profile', {
    headers: {
...
const loadUserRole = async () => {
  const response = await axios.get(process.env.REACT_APP_BEEP_API + "/api/user/my/role", {
    headers: {
      'Content-Type': "application/json",
...
export default {loadProfile, loadRented, loadReturned, loadBookmark, loadUserRole}
