...
function MyPage() {
  ...
  const [numRentees, setNumRentees] = useState({rented: 0, returned: 0, bookmarked: 0})
    ...
    <Body>
      ...
      <RentSection>
        <Button
          ...
          onRentClick={() => {setShowRentees(rentedRentees);}}
          onReturnClick={() => {setShowRentees(returnedRentees);}}
          onBookmarkClick={() => {setShowRentees(bookmarkedRentees);}}
        />
        <RenteeInfoSection>
